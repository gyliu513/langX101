...
class FastMCPTokenGenerator {
     ...
     */
    createToken(options = {}) {
        const { subject = 'dev-user', issuer = 'http://localhost:8000', audience = 'my-mcp-server', scopes = ['read', 'write'], expiresIn = '30d' } = options;
        if (!this.privateKey) {
...
export { FastMCPTokenGenerator, generateFastMCPToken };
