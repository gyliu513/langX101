import { FastMCPTokenGenerator } from './token-generator.js';
import fs from 'fs';
/**
...
class RealFastMCPClient {
    ...
    currentToken;
    tokenExpiry;
    mcpClient; // Using any for LangChain client type
    constructor(options = {}) {
        this.options = {
        ...
        this.tokenGenerator = new FastMCPTokenGenerator(this.options.privateKeyPath, this.options.publicKeyPath);
...
export { RealFastMCPClient, createRealFastMCPClient, realServerExample };
// Run example if called directly
if (import.meta.url === `file://${process.argv[1]}`) {
    realServerExample().catch(console.error);
}
//# sourceMappingURL=real-client.js.map